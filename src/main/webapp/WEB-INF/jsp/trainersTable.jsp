            ...
            <jsp:include page="navbar.jsp"></jsp:include>
                <div class="row my-3">
                    <div class="col-6 offset-3">
                        <img class="rounded img-fluid" src="/img/trainerstable.jpg" width="850" height="400" alt="trainertable">
                    </div>
                </div>
                <div class="row mt-3 bg-light">
                    <h3 class="display-5 text-center"><i>Here are all of our Trainers: </i></h3>
                </div>
                <div class="row mt-1">
